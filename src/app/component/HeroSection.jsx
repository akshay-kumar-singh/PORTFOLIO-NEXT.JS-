      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center sm:justify-start">
            <Link
              href="#contact"
              className="px-4 py-2 sm:py-3 sm:px-6 w-full sm:w-auto rounded-full bg-gradient-to-br from-primary-500 to-secondary-500 hover:bg-slate-800 text-white mt-3 sm:mr-4 transition duration-300 ease-in-out"
            >
              <span>Hire Me</span>
            </Link>
            <Link
              href="/"
              className="px-4 py-2 sm:py-3 sm:px-6 w-full sm:w-auto rounded-full bg-gradient-to-br from-primary-500 to-secondary-500 hover:bg-slate-800 text-white mt-3 transition duration-300 ease-in-out hover:bg-primary-700"
            >
